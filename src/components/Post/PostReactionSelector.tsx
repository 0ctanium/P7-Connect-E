...
export const PostReactionSelector: FC<{
  ...
  const selectedIcon = useMemo(
    () =>
      post.viewerReaction?.icon
        ? icons[post.viewerReaction?.icon as Icons]
        : null,
    [post.viewerReaction]
  );
