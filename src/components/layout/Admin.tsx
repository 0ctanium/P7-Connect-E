...
export const AdminLayout: FC<{ current: string; loading?: boolean }> = ({
  children,
  loading,
  current,
}) => {
...
export const AdminLayoutSection = <Tag extends HTMLElement = HTMLElement>({
  as: Component = 'div',
  children,
  ...props
}: PropsWithChildren<
...
>): JSX.Element => {
  return (
    // @ts-ignore
    <Component className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8" {...props}>
      {children}
    </Component>
  );
};
